...
public class Phone {
	...
	public Phone(long id, String brand, String model, State state,
			double price, double size, boolean sdCard,
	...
	public String toString() {
		return "Phone [id=" + id + ", brand=" + brand + ", model=" + model
				+ ", state=" + state + ", price=" + price + ", size=" + size
				+ ", sdCard=" + sdCard + ", replacableBattery="
				+ replacableBattery + ", camera=" + camera + "]";
	}
